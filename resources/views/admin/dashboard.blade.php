...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{ $data['reportedUsers'] }}</h3>

                    <p>{{ __('Reported Users') }}</p>
                </div>
                <div class="icon">
                    <i class="ion ion-person"></i>
                </div>
                <a href="{{ route('reportedUsers') }}" class="small-box-footer">{{ __('More info') }}<i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
                ...
                <a href="{{ route('income') }}" class="small-box-footer">{{ __('More info') }}<i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-6">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card card-danger">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Income') }} ({{ getCurrencySymbol() }})</h3>
...
@section('script')
    <script type="text/javascript">
        ...
        let maleUsers = "{{ $data['maleUsers'] }}";
        let femaleUsers = "{{ $data['femaleUsers'] }}";
